...
function loadHallTickets() {
    window.location.href = '/hall-tickets';
}
...
const api = {
    ...
    createStudent: (student) => fetch('/api/students/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(student)
    }).then(response => response.json()),
    updateStudent: (id, student) => fetch(`/api/students/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(student)
    }).then(response => response.json()),
    ...
    createStaff: (staff) => fetch('/api/staff/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(staff)
    }).then(response => response.json()),
    updateStaff: (id, staff) => fetch(`/api/staff/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(staff)
    }).then(response => response.json()),
    deleteStaff: (id) => fetch(`/api/staff/${id}`, {
        method: 'DELETE'
    }).then(response => response.json()),
    
    // Halls
    getHalls: () => fetch('/api/halls/').then(response => response.json()),
    createHall: (hall) => fetch('/api/halls/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(hall)
    }).then(response => response.json()),
    updateHall: (id, hall) => fetch(`/api/halls/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(hall)
    }).then(response => response.json()),
    deleteHall: (id) => fetch(`/api/halls/${id}`, {
        method: 'DELETE'
    }).then(response => response.json()),
    
    // Exams
    getExams: () => fetch('/api/exams/').then(response => response.json()),
    createExam: (exam) => fetch('/api/exams/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    // Attendance
    getAttendance: () => fetch('/api/attendance/').then(response => response.json()),
    createAttendance: (attendance) => fetch('/api/attendance/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
