        ...
        <div className="col-md-8">
          <div className="card">
            <div className="card-header">
              <h4><i className="bi bi-building me-2"></i>Upload Halls</h4>
            </div>
            <div className="card-body">
              <form onSubmit={handleUpload}>
                <div className="mb-3">
                  <label htmlFor="hallFile" className="form-label">
                    Select CSV file containing hall data
                  </label>
                  <input
                    type="file"
                ...
                <div className="d-grid">
                  ...
                  >
                    {uploading ? 'Uploading...' : 'Upload Halls'}
                  </button>
                </div>
              </form>
